...
CREATE TABLE "Ingredient" (
    ...
    "lowStockLevel" DOUBLE PRECISION NOT NULL DEFAULT 10,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "Order_kitchenStaffId_idx" ON "Order"("kitchenStaffId");

-- CreateIndex
CREATE INDEX "Order_couponId_idx" ON "Order"("couponId");

-- CreateIndex
CREATE INDEX "Order_cashierSessionId_idx" ON "Order"("cashierSessionId");
...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_kitchenStaffId_fkey" FOREIGN KEY ("kitchenStaffId") REFERENCES "Employee"("id") ON DELETE SET NULL ON UPDATE CASCADE;
